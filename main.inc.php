...
$rcmail_config['default_host'] = 'ssl://serveur.maven2-20.com';
...
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['smtp_server'] = 'ssl://in.mailjet.com';

// SMTP port (default is 25; 465 for SSL)
$rcmail_config['smtp_port'] = 443;
...
$rcmail_config['des_key'] = '6wd2twDyM?d$inVZun*0clhV';
...
// %z - IMAP domain (IMAP hostname without the first part)
// For example %n = mail.domain.tld, %d = domain.tld
$rcmail_config['username_domain'] = 'contact@stickeaz.com';
...
$rcmail_config['product_name'] = 'Stickeaz mail';
